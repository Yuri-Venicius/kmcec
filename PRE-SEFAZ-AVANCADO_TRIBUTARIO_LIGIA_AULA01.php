...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            if (
                ...
                <h2>SEFAZ-MT - PRE EDITAL AVANÇADO - DIREITO TRIBUTÁRIO | PROFESSORA LÍGIA DONONI</h2><h3>AULA 01</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="PRE-SEFAZ-AVANCADO_TRIBUTARIO_LIGIA_AULA02.php">Próximo</a>
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/7omcm2" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                </div>
                <p></p>
