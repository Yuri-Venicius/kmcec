        ...
        <div id="content">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">NOÇÕES DE ADMINISTRAÇÃO PÚBLICA - FERNANDO DAVOLI</h5>
                                    ...
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1glW31K3-H52xEEVImduy7ovzkelALbMs?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                    </p>
                                    <div class="collapse" id="collapseAdmFernando">
                                    <div class="card card-body"> 
                                        <a href="DPE_MEDIO_ADM_DAVOLI_AULA01.php">AULA 01 - GRAVAÇÃO 20/08/2022</a><p></p> 
                                    </div>
                                    </div>    
                        </div>
                    </div><p></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ARQUIVOLOGIA - FERNANDO DAVOLI</h5>
                                    ...
                                    <div class="card card-body"> 
                                        <a href="DPE_MEDIO_ARQUIVOLOGIA_DAVOLI_AULA01.php">AULA 01 - GRAVAÇÃO 23/07/2022</a><p></p> 
                                        <a href="DPE_MEDIO_ARQUIVOLOGIA_DAVOLI_AULA02.php">AULA 02 - GRAVAÇÃO 30/07/2022</a><p></p> 
                                        <a href="DPE_MEDIO_ARQUIVOLOGIA_DAVOLI_AULA03.php">AULA 03 - GRAVAÇÃO 13/08/2022</a><p></p> 
                                    </div>
                                    </div>    
                        </div>
                    </div><p></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">RELAÇÕES INTERPESSOAIS - FERNANDO DAVOLI</h5>
                                    ...
                                    <div class="card card-body"> 
                                        <a href="DPE_MEDIO_RELACOES_DAVOLI_AULA01.php">AULA 01 - GRAVAÇÃO 06/08/2022</a><p></p> 
                                    </div>
                                    </div>    
                        </div>
                    </div><p></p>
