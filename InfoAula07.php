...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h3>Aula 07</h3>
            <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="InfoAula06.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="InfoAula08.php">Próximo</a>
                <p></p>
