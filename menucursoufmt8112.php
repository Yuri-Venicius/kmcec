            ...
            <div class="card-group">
                <div class="card text-center" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="ufmt8112.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                    </div>
                </div>
                <div class="card text-center" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="materiaisufmt8112.php" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                    </div>
                </div>
            </div>
