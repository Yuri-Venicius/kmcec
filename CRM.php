...
<body>
 ...
 <p></p>
        ...
        <div id="content">
            ...
            <h2>Vídeo Aulas - Curso completo CRM</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Noções de Administração Pública</h5>
                            <p class="card-text">Bloco de Administração pública, contendo aulas com o Prof. Wilton e Profª. Cleide.
                                <p>
                                    </p>
                                    <a href="CRM_Adm.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Raciocínio Lógico Matemárico</h5>
                            <p class="card-text">Bloco de Raciocínio Lógico Matemático preparatório para o concurso do CRM-MT(2020).
                                <p>
                                    Ministrado por Prof. Anderson Augusto.</p>
                                    <a href="RLM.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/uc?id=1MgpiDcIDE-ks65ix4vcsPgIAzIi8R1Nz&export=download" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bloco da Informática Básica voltada para o concurso do CRM-MT(2020).
                                <p>
                                    Ministrado por Prof. Wilton Sobrinho.</p>
                                    <a href="infoCRM.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="materiaisInfoCRM.php" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bloco de língua portuguesa voltada para o concurso do CRM-MT(2020)
                                <p>
                                    Ministrado por Prof. Cezar Bodão</p>
                                    <a href="PortuguesCRM.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
