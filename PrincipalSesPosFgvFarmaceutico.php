...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PÓS-EDITAL FGV - CARGO FARMACÊUTICO</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">
                            Acesse clicando <a href="https://docs.google.com/spreadsheets/d/1oz5jy6C238nb4s0KgyAHjSMoNpteFy9T8LQGgTePThs/edit?usp=sharing" class="alert-link" target="_blank">aqui</a>, o link para o cronograma de postagens das aulas do curso.
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseEspFarmaceutico">
                                    <div class="card card-body">
                                        <a href="SES_POS_FARMACEUTICO_ESP_FARMAC_WILLIAM_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_FARMACEUTICO_ESP_FARMAC_WILLIAM_AULA02.php">AULA 02</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO FARMACÊUTICO - CLÁUDIO VENTURINI</h5>
                                <p class="card-text">
                                ...
                                <div class="collapse" id="collapseEspFarmaceuticoClaudio">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_FARMACEUTICO_ESP_FARMAC_CLAUDIO_AULA07.php">AULA 07</a>
                                    </div>
                                </div>
                            </div>
                        </div>
