...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Curso de Informática básica - Aula 06</h2>
            <div>
            <a style="align-items: flex-end;" class="btn btn-primary" href="UFMT_InfoAula05.php">Anterior</a>
            <a style="align-items: flex-end;" class="btn btn-primary" href="UFMT_InfoAula07.php">Próximo</a>
            <p></p>
            <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/ooqdzi" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
            </div>
