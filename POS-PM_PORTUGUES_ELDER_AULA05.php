    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <h2>CARREIRAS POLICIAIS ONLINE PM-MT - PORTUGUÊS | PROFESSOR ELDER</h2><h3>AULA 05</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="POS-PM_PORTUGUES_ELDER_AULA04.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="POS-PM_PORTUGUES_ELDER_AULA06.php">Próximo</a>
