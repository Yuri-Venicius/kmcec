        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card">
                    <div class="card-body">
                            <h5 class="card-title">FÍSICA - ELIZEU</h5>
                            <p class="card-text">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">BIOLOGIA - RODRIGO</h5>
                                    ...
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1In_mBd7H_7aRjtdR0mmfqh5z6AlSY5LU?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                    </p>
                                    <div class="collapse" id="collapseDirPenalKleber">
                                    <div class="card card-body"> 
                                        <a href="BIOEXATAS_BIOLOGIA_RODRIGO_AULA01.php">AULA 01 - GRAVAÇÃO 23/01/2022</a><p></p> 
                                        <a href="BIOEXATAS_BIOLOGIA_RODRIGO_AULA02.php">AULA 02 - GRAVAÇÃO 30/01/2022</a><p></p> 
                                        <a href="BIOEXATAS_BIOLOGIA_RODRIGO_AULA03.php">AULA 03 - GRAVAÇÃO 06/02/2022</a><p></p> 
                                        <a href="BIOEXATAS_BIOLOGIA_RODRIGO_AULA04.php">AULA 04 - GRAVAÇÃO 13/02/2022</a><p></p> 
                                    </div>
                                    </div>    
                        </div>
                    </div><p></p>
