...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Vídeo Aulas - Isoladas do KM</h2>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a style="margin-left: 30px;" href="https://drive.google.com/uc?id=1zWoZxaGGkXXjFw_K4bQSrj7kgGpV_IYD&export=download" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
