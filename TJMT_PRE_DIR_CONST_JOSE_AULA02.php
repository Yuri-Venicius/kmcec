...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>CURSO PARA O TJ-MT PRÉ-EDITAL - DIREITO CONSTITUCIONAL | PROFESSOR JOSÉ NETO</h2><h3>AULA 02</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="TJMT_PRE_DIR_CONST_JOSE_AULA01.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="TJMT_PRE_DIR_CONST_JOSE_AULA03.php">Próximo</a>
                <p></p>
