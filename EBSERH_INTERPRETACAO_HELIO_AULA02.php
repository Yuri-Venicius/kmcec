...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <!-- Page Content  -->
            <div id="content">
                <h2>EBSERH - INTERPRETAÇÃO DE TEXTO | PROFESSOR HÉLIO TAQUES</h2><h3>AULA 02</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="EBSERH_INTERPRETACAO_HELIO_AULA01.php">Anterior</a>
                <p></p>
