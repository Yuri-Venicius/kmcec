...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PÓS-EDITAL FGV - CARGO MÉDICO</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">
                            Acesse clicando <a href="https://docs.google.com/spreadsheets/d/1reXoalDE1AL1RuIzpSr9fouY3-n92d49J8EZKiUS778/edit?usp=sharing" class="alert-link" target="_blank">aqui</a>, o link para o cronograma de postagens das aulas do curso.
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert">
                            Acesse clicando <a href="https://meet.google.com/vxn-jjfs-snd" class="alert-link" target="_blank">aqui</a>, o link para sala de aula da MATÉRIA ESPECÍFICA! (Transmissão segue o cronograma ao lado)
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO MÉDICO - MARCOS SERRANO</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspMedico" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1G2-BnP0DtsylJioqVgj56vHyrkqWPUW3?usp=drive_link" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEspMedico">
                                    <div class="card card-body">
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA03.php">AULA 03</a>
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA04.php">AULA 04</a>
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA05.php">AULA 05</a>
                                        <a href="SES_POS_MEDICO_ESP_MARCOS_AULA06.php">AULA 06</a>
                                    </div>
                                </div>
                            </div>
                        </div>
