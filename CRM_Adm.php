...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Vídeo Aulas - Noções de Administração Pública</h2>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bloco de Atos Administrativos
                                <p>
                                    Ministrado pela Profª. Cleide Regina</p>
                                    <a href="DirAdm_Atos.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/uc?id=1tOlL6SarwJI5VONICDvkXVXJF_Lzac1x&export=download" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bloco de Administração Pública.
                                <p>
                                    Ministrado por Prof. Wilton Sobrinho.</p>
                                    <a href="AdmPublica.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
