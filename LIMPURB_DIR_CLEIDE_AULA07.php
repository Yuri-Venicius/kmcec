...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>CURSO PARA LIMPURB - DIREITO ADMINISTRATIVO | PROFESSORA CLEIDE REGINA</h2>
            <h3>AULA 07</h3>
            <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="LIMPURB_DIR_CLEIDE_AULA06.php">Anterior</a>
                <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="LIMPURB_DIR_CLEIDE_AULA06.php">Próximo</a> -->
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/huzzz0" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
            </div>
            <p></p>
            <div class="col-sm-6" style="margin: center">
                <div class="card">
                    ...
                    <p class="card-text">
                    <h5 style="margin-left: 30px; margin-right: 30px;">COMO ACELERAR O VÍDEO?</h5>
                    </p>
                    <p class="card-text">
                    <h5 style="margin-left: 30px; margin-right: 30px;"> Caso esteja no celular: Basta clicar na opção engrenagem e escolher a velocidade desejada<H5>
                            </p>
                            <p class="card-text">
                            <h5 style="margin-left: 30px; margin-right: 30px;"> Caso esteja no Computador: Basta clicar com o botão direito do mouse e escolher a velocidade desejada<H5>
                                    </p>
                </div>
            </div>
        </div>
