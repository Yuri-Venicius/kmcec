            ...
            <div class="row">
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Caixa Econômica Federal Pós edital [Online]</h5>
                                <p class="card-text">Curso preparatório pós edital online ao vivo para o concurso da Caixa Economica Federal 2024.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalCaixaEconomica2024.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Básico todos os cargos</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtBasico.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Administrador</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtAdministrador.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Contador</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtContador.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Enfermagem/Tec. Enfermagem</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtEnfermagemTecEnfermagem.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Farmacêutico</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtFarmaceutico.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Fisioterapeuta</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtFisioterapia.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Médico</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtMedico.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Aulão de véspera SES-MT - Técnico em Assuntos Culturais e Educacionais</h5>
                                <p class="card-text">Sala de aula para transmissão ao vivo da SES-MT do aulão.
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalAulaoVesperaSesMtTecAssuntos.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
                ...
                if (
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">SES-MT Pós edital FGV - Farmacêutico [Online]</h5>
                                <p class="card-text">Curso preparatório para o concurso da SES-MT, Farmacêutico, Online ao vivo
                                </p>
                                </p>
                                <p></p>
                                <a href="PrincipalSesPosFgvFarmaceutico.php" class="btn btn-primary">Acessar</a>
                                <!-- <a style="margin-left: 30px;" href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> -->
                            </div>
                        </div>
                        <p></p>
