...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p>Bloco de conteúdos bônus para os alunos do curso de PF/PRF</p>
            ...
            <div class="row">
                ...
                <!-- <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Informática Básica para Concursos</h5>
                            <p class="card-text">Bloco de Informática Básica para Concursos.
                                <p>
                                    Ministrado por Prof Wilton Sobrinho.</p>
                                    <a href="infoUFMT.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Raciocínio Lógico Matemático</h5>
                            <p class="card-text">Bloco de RLM.
                                <p>
                                    Ministrado por Prof Anderson Augusto.</p>
                                    <a href="RLM.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a href= "https://drive.google.com/uc?id=1MgpiDcIDE-ks65ix4vcsPgIAzIi8R1Nz&export=download" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bloco de Macetes de Português
                                <p>
                                    Ministrado por Prof Gouveia.</p>
                                    <a href="aulasPortugues.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a href="materiaisPortugues.php" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div>
                </div>
