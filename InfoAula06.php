...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Curso de Informática Básica para Concursos.</h2>
            <h3>Aula 06</h3>
            <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="InfoAula05.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="InfoAula07.php">Próximo</a>
                <p></p>
