            ...
            if (
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapsePtHelio">
                                    <div class="card card-body">
                                        <a href="GMLRV_PORTUGUES_HELIO_AULA01.php">AULA 01 - GRAVAÇÃO 05/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapsePtElder">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_PORTUGUES_ELDER_AULA02.php">AULA 02 - GRAVAÇÃO 27/05/2023</a>
                                        <a href="GMLRV_PORTUGUES_ELDER_AULA03.php">AULA 03 - GRAVAÇÃO 06/06/2023</a>
                                        <a href="GMLRV_PORTUGUES_ELDER_AULA04.php">AULA 04 - GRAVAÇÃO 13/06/2023</a>
                                        <a href="GMLRV_PORTUGUES_ELDER_AULA05.php">AULA 05 - GRAVAÇÃO 22/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseInfoJoao">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_INFORMATICA_JOAO_AULA03.php">AULA 03 - GRAVAÇÃO 02/06/2023</a>
                                        <a href="GMLRV_INFORMATICA_JOAO_AULA04.php">AULA 04 - GRAVAÇÃO 15/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseDirNeto">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_DIREITOCONST_JOSE_AULA05.php">AULA 05 - GRAVAÇÃO 20/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseDirCleice">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_DIREITOADM_CLEIDE_AULA04.php">AULA 04 - GRAVAÇÃO 01/06/2023</a>
                                        <a href="GMLRV_DIREITOADM_CLEIDE_AULA05.php">AULA 05 - GRAVAÇÃO 21/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseDirLuiz">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_DIREITOPENAL_LUIZ_AULA03.php">AULA 03 - GRAVAÇÃO 09/06/2023</a>
                                        <a href="GMLRV_DIREITOPENAL_LUIZ_AULA04.php">AULA 04 - GRAVAÇÃO 12/06/2023</a>
                                        <a href="GMLRV_DIREITOPENAL_LUIZ_AULA05.php">AULA 05 - GRAVAÇÃO 19/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseLegGuilhemre">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_LEGPENAL_GUILHERME_AULA02.php">AULA 02 - GRAVAÇÃO 26/05/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">LEGISLAÇÃO DA GCM LRV - FERNANDO DAVOLI</h5>
                                <p class="card-text">
                                ...
                                <div class="collapse" id="collapseLeg">
                                    <div class="card card-body">
                                        ...
                                        <a href="GMLRV_LEGGCM_DAVOLI_AULA03.php">AULA 03 - GRAVAÇÃO 14/06/2023</a>
                                        <a href="GMLRV_LEGGCM_DAVOLI_AULA04.php">AULA 04 - GRAVAÇÃO 17/06/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ESTATUTO DO SERVIDOR - CLEIDE REGINA</h5>
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEstatutoCleider" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1wRtPxjLz8KY1mgZYrPbwD_L3Lq4sjMzi?usp=drive_link" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                    </p>
