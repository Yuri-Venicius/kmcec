...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>AULÃO DE VÉSPERA SES-MT CARGO ENFERMAGEM E TÉC. DE ENFERMAGEM - TRANSMISSÃO AO VIVO</h2>
            <p></p>
            ...
            if (
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">SALA PARA A TRANSMISSÃO DO AULÃO DE VÉSPERA</h5>
                                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseSalaAulao" aria-expanded="false" aria-controls="collapseExample">
                                    <i class="fas fa-play-circle"></i> Link Sala de Aula
                                </button>
                                ...
                                <div class="collapse" id="collapseSalaAulao">
                                    <div class="card card-body">
                                        <a>Aulão previsto para 13/04/24</a>
                                    </div>
                                </div>
                            </div>
                        </div>
