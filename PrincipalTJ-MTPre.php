                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-primary" role="alert">
                            Acesse clicando  <a href="https://docs.google.com/spreadsheets/d/17LIy5c-i4z2e97b07kAIm7pErRXBFc_xAphwUG1QEPk/edit?usp=sharing" class="alert-link">aqui</a>, o cronograma de gravações deste curso!
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseDirCivilStanley">
                                    <div class="card card-body">
                                        <a href="TJMT_PRE_DIR_CIVIL_STANLEY_AULA01.php">AULA 01 - GRAVAÇÃO 18/02/2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
