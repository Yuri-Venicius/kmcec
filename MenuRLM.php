...
<body>
 ...
 <p></p>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <!-- Page Content  -->
            <h2>Curso de Raciocínio Lógico Matematico</h2><p></p>
            <h6> Para acessar aos blocos de vídeo aulas, clique em "Vídeo Aulas" ou se quiser fazer o download do material de apoio às aulas, só clicar em "Materiais".</h6>
            <p></p>
            <div class="card-group">
                <div class="card text-center" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Vídeo Aulas</h5>
                        <p class="card-text">Acessar minhas vídeo aulas disponíveis.</p>
