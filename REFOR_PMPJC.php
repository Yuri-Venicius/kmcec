            ...
            <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                    <a href="REFOR_PMPJC_PT_GOUVEIA.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1W5HKOJdolvYEX8gGBWIZcZG7a4xYqWIF?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                        </div>
                    </div><p></p>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                    <a href="REFOR_PMPJC_INFO_SILVIO.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1_MoyiPcHqlx15aUzobBzlDoTKM4B3KBm?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">RACIOCÍNIO LÓGICO - IGOR BRASIL</h5>
                                    <a href="REFOR_PMPJC_RLM_IGOR.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1vspmhV7gz2eP31iquY0qfGpy23nbQ1uU?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                        </div>
                    </div><p></p>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">PORTUGUÊS - CÉSAR BODÃO</h5>
                                    <a href="REFOR_PMPJC_PT_BODAO.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1ZwKTc9Gz9Gg1avMKyO1_LdcG2pQVdQJv?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                        </div>
                    </div><p></p>
                </div>
