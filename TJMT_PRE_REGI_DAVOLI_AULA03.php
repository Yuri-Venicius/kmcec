...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>CURSO PARA O TJ-MT PRÉ-EDITAL - REGIMENTO INTERNO | PROFESSOR FERNANDO DAVOLI</h2><h3>AULA 03</h3>
                <div>
                    <a style="align-items: flex-end;" class="btn btn-primary" href="TJMT_PRE_REGI_DAVOLI_AULA02.php">Anterior</a>
                    <p></p>
                    <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/gx3ohu" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                </div>
                <p></p>
            </div>
