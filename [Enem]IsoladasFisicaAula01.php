...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>ISOLADAS DO KM PARA ENEM - FÍSICA | PROFESSOR IGOR BRASIL</h2><h3>AULA 01</h3>
                <div>
                <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="[Enem]IsoladasFisicaAula02.php">Próximo</a> -->
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://www.youtube.com/embed/FcOGaeJeAL8?list=PLmYBZhAS774P083A91WhKTYANdpopMFIi" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                </div>
                <p></p>
            </div>
