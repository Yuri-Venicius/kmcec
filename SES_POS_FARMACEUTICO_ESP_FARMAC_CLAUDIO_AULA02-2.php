...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Page Content  -->
        <div id="content">
            <h2>SES-MT PÓS EDITAL - ESPECÍFICO FARMACÊUTICO | PROFESSOR CLÁUDIO VENTURI</h2>
            <h3>AULA 02 - Parte 2</h3>
            <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="SES_POS_FARMACEUTICO_ESP_FARMAC_CLAUDIO_AULA02-1.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="SES_POS_FARMACEUTICO_ESP_FARMAC_CLAUDIO_AULA02-3.php">Próximo</a>
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://www.youtube.com/embed/diMO1TvS9kU" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
            </div>
            <p></p>
        </div>
