    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <h2>DEFENSORIA PÚBLICA DE MT - ÉTICA E FILOSOFIA | PROFESSOR DOUGLAS REMONATTO</h2><h3>AULA 02</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="DPE_MEDIO_ETICA_DOUGLAS_AULA01.php">Anterior</a>
