...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>CURSO PARA O TJ-MT PRÉ-EDITAL - LÍNGUIA PORTUGUESA | PROFESSOR ELDER DENCATI</h2><h3>AULA 04</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="TJMT_PRE_PORTUGUES_ELDER_AULA03.php">Anterior</a>
                <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="TJMT_PRE_PORTUGUES_ELDER_AULA05.php">Próximo</a> -->
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/42solq" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                </div>
                <p></p>
