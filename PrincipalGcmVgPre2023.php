                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseRLMigor">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_RLM_IGOR_AULA07.php">AULA 07</a>
                                    <a href="GUARDAVG2023_RLM_IGOR_AULA08.php">AULA 08</a>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapsePthELIO">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_PT_HELIO_AULA03.php">AULA 03</a>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapsePthGouveia" aria-expanded="false" aria-controls="collapseExample">
                                    <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                </button>
                                <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1lkFQsNIbAPygHKf2KG4DihEljuw_Fgzu?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                            </p>
                            <div class="collapse" id="collapsePthGouveia">
                                <div class="card card-body">
                                    <a href="GUARDAVG2023_PT_GOUVEIA_AULA01.php">AULA 01</a>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1KCP0J66D9DpmDbmouP5w8R-BIE5C0hme?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                            </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseDirJoseNeto">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_DIR_CONSTITUCIONAL_JOSE_AULA05.php">AULA 05</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseDirAdmCleide">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_DIR_ADM_CLEIDE_AULA02.php">AULA 02</a>
                                    <a href="GUARDAVG2023_DIR_ADM_CLEIDE_AULA03.php">AULA 03</a>
                                    <a href="GUARDAVG2023_DIR_ADM_CLEIDE_AULA04.php">AULA 04</a>
                                    <a href="GUARDAVG2023_DIR_ADM_CLEIDE_AULA05.php">AULA 05</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseInterHelio">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_INTERPRETACAO_HELIO_AULA02.php">AULA 02</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapsCtbAlan">
                                <div class="card card-body">
                                    ...
                                    <a href="GUARDAVG2023_CTB_ALAN_AULA03.php">AULA 03</a>
                                    <a href="GUARDAVG2023_CTB_ALAN_AULA04.php">AULA 04</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/17EjXEr_cg0avPYfB_oeuIRipCwzVGM34?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                            </p>
                            <div class="collapse" id="collapseHistBidu">
                                <div class="card card-body">
                                    <a href="GUARDAVG2023_HISTORIA_BIDU_AULA01.php">AULA 01</a>
                                    <a href="GUARDAVG2023_HISTORIA_BIDU_AULA02.php">AULA 02</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseGeoMarcelo">
                                <div class="card card-body">
                                    <a href="GUARDAVG2023_GEOGRAFIA_MARCELO_AULA01.php">AULA 01</a>
                                    <a href="GUARDAVG2023_GEOGRAFIA_MARCELO_AULA02.php">AULA 02</a>
                                </div>
                            </div>
                        </div>
                    </div>
