        ...
        <div id="content">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">HISTÓRIA - CARLÃO</h5>
                                    <a href="PMPJC_HISTORIA_CARLAO.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1DKjTgwXl9CZ8ZTzBjEZ0QX3Eijx2Y7e_?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                        </div>
                    </div><p></p>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">CONTABILIDADE - EDELMIRA</h5>
                                    <a href="PMPJC_CONTABILIDADE_EDELMIRA.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/19_bFpvAEYRXtz0TDMn8L2jHwfmmUw_4f?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                        </div>
                    </div><p></p>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">DIREITOS HUMANOS - KLEBER PINHO</h5>
                                    <a href="PMPJC_DIR_HUM_KLEBER.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1RUSZBa7p7H38Nigoz_be8uTNmX1f22Sn?usp=sharing" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                        </div>
                    </div><p></p>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">BÔNUS - AULAS DE REFORÇO</h5>
                                    <a href="REFOR_PMPJC.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">BÔNUS - SIMULADOS</h5>
                                    <a href="https://drive.google.com/drive/folders/1yNcjZmXC3_aN3U2U01eTW5sG7qsHljaP?usp=sharing" class="btn btn-primary"><i class="fas fa-play-circle"></i> Acessar</a>
