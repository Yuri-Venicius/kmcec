...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Curso de Informática para o CRM 2020 - Aula 06</h2>
            <div>
            <a style="align-items: flex-end;" class="btn btn-primary" href="CRM_InfoAula05.php">Anterior</a>
            <a style="align-items: flex-end;" class="btn btn-primary" href="CRM_InfoAula07.php">Próximo</a>
            <p></p>
            <iframe width="1140" height="640" src="https://www.youtube.com/embed/t5jxJUO4pBU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
