...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>ISOLADAS DO KM PARA ENEM - QUÍMICA | PROFESSOR MARCIANO</h2><h3>AULA 03</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="[Enem]IsoladasQuimicaAula02.php">Anterior</a>
                <a style="align-items: flex-end;" class="btn btn-primary" href="[Enem]IsoladasQuimicaAula04.php">Próximo</a>
                <p></p>
                <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://www.youtube.com/embed/o-bYiD7EJZg" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
                </div>
                <p></p>
            </div>
