    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="col-sm-6">
                    ...
                    </div><p>Não há conteúdo disponível ainda.</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">MATEMÁTICA - IGOR BRASIL</h5>
                                    <!-- <a href="#" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">BIOLOGIA - RODRIGO CESAR</h5>
                                    <!-- <a href="#" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="#" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>  -->
                        </div>
                    </div><p>Não há conteúdo disponível ainda.</p>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">QUÍMICA - DOUGLAS RAMALHO</h5>
                                    <!-- <a href="#" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="#" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>  -->
                        </div>
                    </div><p>Não há conteúdo disponível ainda.</p>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ESTATUTO DO SERVIDOR - FERNANDO DAVOLI</h5>
                                    <!-- <a href="#" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="#" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>  -->
                        </div>
                    </div><p>Não há conteúdo disponível ainda.</p>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">LEGISLAÇÃO BÁSICA - FERNANDO DAVOLI</h5>
                                    <!-- <a href="#" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                                    <a style="margin-left: 30px;" href="#" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>  -->
                        </div>
                    </div><p>Não há conteúdo disponível ainda.</p>
