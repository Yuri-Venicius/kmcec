...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <!-- Page Content  -->
            <div id="content">
                <h2>CURSO PARA SEDUC 2023 - INFORMÁTICA | PROFESSOR JOÃO CLEBER</h2><h3>AULA 03</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="SEDUC_INFO_JOAO_AULA02.php">Anterior</a>
                <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="SEDUC_INFO_JOAO_AULA04.php">Próximo</a> -->
                <p></p>
