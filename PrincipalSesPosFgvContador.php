...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PÓS-EDITAL FGV - CARGO CONTADOR</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">
                            Acesse clicando <a href="https://docs.google.com/spreadsheets/d/1ZMZSmrSNXNLEqFjbd9ETAEXz-w7dCCGhzRLpxUz_ego/edit?usp=sharing" class="alert-link" target="_blank">aqui</a>, o link para o cronograma de postagens das aulas do curso.
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert">
                            Acesse clicando <a href="https://meet.google.com/gbi-etms-umr" class="alert-link" target="_blank">aqui</a>, o link para sala de aula ao vivo MATÉRIAS ESPECÍFICAS! (Transmissão segue o cronograma ao lado)
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO CONTABILIDADE - DANIEL MERRELES</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspContabilidade" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1qGBjfOOKaesIgOcBsfyiN0gdtJaUp-dN?usp=drive_link" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEspContabilidade">
                                    <div class="card card-body">
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA03.php">AULA 03</a>
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA04.php">AULA 04</a>
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA05.php">AULA 05</a>
                                        <a href="SES_POS_ESP_CONTABILIDADE_DANIEL_AULA06.php">AULA 06</a>
                                    </div>
                                </div>
                            </div>
                        </div>
