...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Curso de Raciocínio Lógico Matematico - Aula 09</h2><h3>Tabela Verdade</h3>
            <div>
            <a style="align-items: flex-end;" class="btn btn-primary" href="RLM_Aula08.php">Anterior</a>
            <a style="align-items: flex-end;" class="btn btn-primary" href="RLM_Aula10.php">Próximo</a>
            <p></p>
            <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/821gv3" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
            </div>
