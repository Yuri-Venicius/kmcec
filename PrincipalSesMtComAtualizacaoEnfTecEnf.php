...
<body>
 ...
 <p></p>
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PRÉ-EDITAL - COM ATUALIZAÇÃO PARA PÓS EDITAL - ENFERMAGEM E TÉC. DE ENFERMAGEM</h2>
            ...
            if (
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">CURSO PRÉ-EDITAL SES-MT 2023 - ENFERMAGEM E TÉC. DE ENFERMAGEM</h5>
                                <p class="card-text">
                                    <a style="margin-left: 30px;" href="PrincipalSES-MT-Pre-Enf-TecEnf.php" class="btn btn-primary"><i class="fas fa-book-open"></i> ACESSAR O CURSO</a>
                                </p>
                            </div>
                        </div>
                        <p></p>
