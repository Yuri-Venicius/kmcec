    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <h2>GUARDA MUNICIPAL DE VG - INTERPRETAÇÃO DE TEXTO | PROFESSOR HÉLIO</h2><h3>AULA 01</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="GUARDAVG_REDACAO_HELIO_AULA02.php">Próximo</a>
