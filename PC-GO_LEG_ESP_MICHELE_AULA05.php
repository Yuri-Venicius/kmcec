...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            if (
                ...
                <h2>CARREIRAS POLICIAIS ONLINE PC GOIÁS - LEG. PENAL ESPECIAL | PROFESSORA MICHELE DONEGÁ</h2><h3>AULA 05</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="PC-GO_LEG_ESP_MICHELE_AULA04.php">Anterior</a>
                <p></p>
