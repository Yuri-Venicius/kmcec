...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PÓS-EDITAL FGV - CARGO FISIOTERAPIA</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">
                            Acesse clicando <a href="https://docs.google.com/spreadsheets/d/1uu6YyEH5jm_sxm-Mnn-OVW8TXVjuNLXjNdXH4ROoR1M/edit?usp=sharing" class="alert-link" target="_blank">aqui</a>, o link para o cronograma de postagens das aulas do curso.
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert">
                            Acesse clicando <a href="https://meet.google.com/ciw-ovyr-ojk" class="alert-link" target="_blank">aqui</a>, o link para sala de aula da MATÉRIA ESPECÍFICA! (Transmissão segue o cronograma ao lado)
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO FISIOTERAPIA - IGOR SILVA</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspFisio" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1c_bulxWxGGDRHbyzEDcH9S1vge98aQQL?usp=drive_link" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEspFisio">
                                    <div class="card card-body">
                                        <a href="SES_POS_FISIO_ESP_IGOR_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_FISIO_ESP_IGOR_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_FISIO_ESP_IGOR_AULA03.php">AULA 03</a>
                                        <a href="SES_POS_FISIO_ESP_IGOR_AULA04.php">AULA 04</a>
                                        <a href="SES_POS_FISIO_ESP_IGOR_AULA05.php">AULA 05</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO FISIOTERAPIA - MARITZA</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspFisioMaritza" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1ppm5GfbDnHLMKLasHJDxfchENvAgyX4G" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEspFisioMaritza">
                                    <div class="card card-body">
                                        <a href="SES_POS_FISIO_ESP_MARITZA_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_FISIO_ESP_MARITZA_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_FISIO_ESP_MARITZA_AULA03.php">AULA 03</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseConstNeto">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_PORTUGUES_HELIO_AULA05.php">AULA 05</a>
                                        <a href="SES_POS_TODOS_PORTUGUES_HELIO_AULA06.php">AULA 06</a>
                                        <a href="SES_POS_TODOS_PORTUGUES_HELIO_AULA07.php">AULA 07</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapsePtGouveia">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_PORTUGUES_GOUVEIA_AULA03.php">AULA 03</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseLegSusDavoli">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_LEG_SUS_DAVOLI_AULA08.php">AULA 08</a>
                                        <a href="SES_POS_TODOS_LEG_SUS_DAVOLI_AULA09.php">AULA 09</a>
                                        <a href="SES_POS_TODOS_LEG_SUS_DAVOLI_AULA10.php">AULA 10</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseRlmIgor">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_RLM_IGOR_AULA05.php">AULA 05</a>
                                        <a href="SES_POS_TODOS_RLM_IGOR_AULA06.php">AULA 06</a>
                                        <a href="SES_POS_TODOS_RLM_IGOR_AULA07.php">AULA 07</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseConstEstJose">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_CONST_EST_JOSE_AULA02.php">AULA 02</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ADMINISTRAÇÃO PÚBLICA - FERNANDO DAVOLI</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseAdmPubDavoli" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/18aHVmNkGXxsZHAIVTXy55n68tBQtw68s" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseAdmPubDavoli">
                                    <div class="card card-body">
                                        <a href="SES_POS_TODOS_ADMINPUB_DAVOLI_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_TODOS_ADMINPUB_DAVOLI_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_TODOS_ADMINPUB_DAVOLI_AULA03.php">AULA 03</a>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEstServidorCleide" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1Qoc7hs0uFvG9f37UTAu_Tai7j1G0VbUM" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/18GXTtO71PqxnVPtfAIahPVZtoOmRUAAw" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseHistBiduPos" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                ...
                                <div class="collapse" id="collapseHistBiduPos">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_TODOS_HISTORIA_BIDU_AULA03.php">AULA 03</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/108EscShqoTA4h7A8fY4ekTY7FoqpCNwu" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEticaDouglas">
                                    <div class="card card-body">
                                        <a href="SES_POS_TODOS_ETICA_DOUGLAS_AULA01.php">AULA 01</a>
                                    </div>
                                </div>
                            </div>
                        </div>
