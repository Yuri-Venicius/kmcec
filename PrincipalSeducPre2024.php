                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapsePtHelio">
                                <div class="card card-body">
                                    ...
                                    <a href="SEDUC_PRE_2024_PORTUGUES_HELIO_AULA03.php">AULA 03</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseEcaCleide">
                                <div class="card card-body">
                                    <a href="SEDUC_PRE_2024_ECA_CLEIDE_AULA01.php">AULA 01</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseHistBidu">
                                <div class="card card-body">
                                    ...
                                    <a href="SEDUC_PRE_2024_HIST_BIDU_AULA03.php">AULA 03</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1mBx1Ens1ELFTV7Dc6PeSGz5mxYKJADJh" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                            </p>
                            <div class="collapse" id="collapseConstEstJose">
                                <div class="card card-body">
                                    <a href="SEDUC_PRE_2024_CONST_NETO_AULA01.php">AULA 01</a>
                                </div>
                            </div>
                        </div>
                    </div>
