...
$verificaAdm = buscaDadosBasicosUsuario($conexao, $_SESSION['usuario']);
 ...
 <p></p>
            ...
            <div id="content">
                ...
                <h2>EBSERH - RACIOCÍNIO LÓGICO | PROFESSOR IGOR BRASIL</h2><h3>AULA 08</h3>
                <div>
                <a style="align-items: flex-end;" class="btn btn-primary" href="EBSERH_RLM_IGOR_AULA07.php">Anterior</a>
                <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="EBSERH_RLM_IGOR_AULA09.php">Próximo</a> -->
                <p></p>
