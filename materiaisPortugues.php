...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
        <h2>Materiais para Download - Curso Português para Concursos</h2><p></p><p></p>
            <div class="card" style="width: 18rem;">
                <a href="https://drive.google.com/uc?id=1aJSD43H2jarfO_ySE71Si44OJx4X_Asq&export=download"><img src="/assets/pdf.png" class="card-img-top" alt="..."></a>

                <div class="card-body">

                    <p class="card-text">Clique na imagem para fazer o download do seu arquivo</p>
                </div>
            </div>
