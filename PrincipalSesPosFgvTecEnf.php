...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>VÍDEO AULAS - CURSO PARA O CONCURSO DA SES-MT PÓS-EDITAL FGV - TÉCNICO DE ENFERMAGEM</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Curso preparatório para o concurso da SES MT, específico para ENFERMAGEM E TÉCNICO DE ENFERMAGEM pré-edital.
                                </p>
                                </p>
                                <p></p>
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-success" role="alert">
                            Acesse clicando <a href="https://docs.google.com/spreadsheets/d/1ZH2GnArXxO0X2n0MaYezkPJsh1M8CfvLqra089RxWac/edit?usp=sharing" class="alert-link" target="_blank">aqui</a>, o link para o cronograma de postagens das aulas do curso.
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert">
                            Acesse clicando <a href="https://meet.google.com/uiy-eyio-zbo" class="alert-link" target="_blank">aqui</a>, o link para sala de aula MATÉRIAS ESPECÍFICAS! (Transmissão segue o cronograma ao lado)
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseEspecificoEnf">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_ENFTECENF_ESPECIFICO_GEOVANNE_AULA06.php">AULA 06</a>
                                        <a href="SES_POS_ENFTECENF_ESPECIFICO_GEOVANNE_AULA07.php">AULA 07</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO ENFERMAGEM - RICHARD</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspecificoEnfRichard" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseInfoJoaoCleber">
                                    <div class="card card-body">
                                        <a href="SES_POS_TODOS_INFO_JOAO_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_TODOS_INFO_JOAO_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_TODOS_INFO_JOAO_AULA03.php">AULA 03</a>
                                    </div>
                                </div>
                            </div>
                        </div>
