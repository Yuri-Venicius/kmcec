        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ESPECÍFICO TÉCNICO ADMINISTRATIVO</h5>
                            <p class="card-text">
                                ...
                                <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1Vw7fMTuYBNbQ2wHpUtDl2_-n-S6pSaIR?usp=share_link" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a> 
                            </p>
                            <div class="collapse" id="collapseEspecifico">
                                <div class="card card-body">
                                    ...
                                    <a href="SMS_ESPECIFICO_TECADM_DAVOLI_AULA03_1.php">AULA 03 PT 1 - DAVOLI - GRAVAÇÃO 21/01/2023</a><p></p> 
                                    <a href="SMS_ESPECIFICO_TECADM_DAVOLI_AULA03_2.php">AULA 03 PT 2 - DAVOLI - GRAVAÇÃO 21/01/2023</a><p></p> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapsePortuguesElder">
                                <div class="card card-body">
                                    ...
                                    <a href="SMS_TODOS_PORTUGUES_ELDER_AULAEXTRA2.php">AULA EXTRA - 26/01/2023</a><p></p> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseRaciocinioIgor">
                                <div class="card card-body">
                                    ...
                                    <a href="SMS_TODOS_RACIOCINIO_IGOR_AULA08.php">AULA 08 - GRAVAÇÃO 18/01/2023 </a><p></p> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseGeografiaMarcelo">
                                <div class="card card-body">
                                    ...
                                    <a href="SMS_TODOS_GEOGRAFIA_MARCELO_AULA05.php">AULA 05 - GRAVAÇÃO 24/01/2023</a><p></p> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseRelDavoli">
                                <div class="card card-body">
                                    ...
                                    <a href="SMS_TODOS_LEGISLACAO_DAVOLI_AULA06.php">AULA 06 - GRAVAÇÃO 19/01/2023</a><p></p> 
                                    <a href="SMS_TODOS_LEGISLACAO_DAVOLI_AULA07.php">AULA 07 - GRAVAÇÃO 23/01/2023</a><p></p> 
                                </div>
                            </div>
                        </div>
                    </div>
