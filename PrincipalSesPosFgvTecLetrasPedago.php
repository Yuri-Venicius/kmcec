            ...
            if (
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseEspLetras">
                                    <div class="card card-body">
                                        ...
                                        <a href="SES_POS_ESP_PEDAGOGO_OZANIL_AULA03.php">AULA 03</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ESPECÍFICO LETRAS/PEDAGOGIA - HÉLIO TAQUES</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEspLetrasHelio" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1oe-pBezZWweoPV0xL63yOtaBqdsoC5uz" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEspLetrasHelio">
                                    <div class="card card-body">
                                        <a href="SES_POS_ESP_PEDAGOGO_HELIO_AULA01.php">AULA 01</a>
                                        <a href="SES_POS_ESP_PEDAGOGO_HELIO_AULA02.php">AULA 02</a>
                                        <a href="SES_POS_ESP_PEDAGOGO_HELIO_AULA03.php">AULA 03</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">ECA - CLEIDE REGINA</h5>
                                <p class="card-text">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseEcaCleide" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="fas fa-play-circle"></i> AULAS DISPONÍVEIS
                                    </button>
                                    <a style="margin-left: 30px;" href="https://drive.google.com/drive/folders/1Sq80uL_3KpTDdHAptudXXPYc-g42zD2u" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                                </p>
                                <div class="collapse" id="collapseEcaCleide">
                                    <div class="card card-body">
                                        <a href="SES_POS_ECA_CLEIDE_AULA01.php">AULA 01</a>
                                    </div>
                                </div>
                            </div>
                        </div>
