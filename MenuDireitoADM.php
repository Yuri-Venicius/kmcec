...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <!-- Page Content  -->
            <h2>Curso completo Noções de Direito Administrativo</h2><p></p>
            ...
            <div class="card-group">
                <div class="card text-center" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="DireitoADM.php" class="btn btn-primary"><i class="fas fa-play-circle"></i> Aulas</a>
                    </div>
                </div>
                <div class="card text-center" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="" class="btn btn-primary"><i class="fas fa-book-open"></i> Materiais</a>
                    </div>
                </div>
            </div>
