...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Infrações de Trânsito - Aula 01</h2><h3></h3>
            <div>
            <a style="align-items: flex-end;" class="btn btn-primary" href="InfracaoTransito_Aula02.php">Próximo</a>
            <!-- <a style="align-items: flex-end;" class="btn btn-primary" href="InfracaoTransito_Aula02.php">Próximo</a> -->
            <p></p>
            <iframe width="1160" height="640" src="https://www.youtube.com/embed/4A47bSWpDoE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
